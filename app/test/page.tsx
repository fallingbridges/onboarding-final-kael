      ...
      <>
        ...
        <div className="gate-page">
          <form onSubmit={submitToken} className="gate-card">
            ...
            <h1 className="gate-title">Kael's First Read</h1>
      ...
      <div className="tester" style={S.page}>
        ...
        <header className="topbar-sticky" style={S.topbar}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, position: "relative", zIndex: 1 }}>
            <KaelLogo height={28} />
            <div style={S.title}>Kael's First Read</div>
          </div>
        ...
        {/* System prompt with cat peeking behind */}
        ...
        <section className="pane-card" style={{ ...S.promptCard, position: "relative", zIndex: 1 }}>
          <button onClick={() => setPromptOpen((o) => !o)} style={S.promptHeader}>
            <span style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <span style={S.caret}>{promptOpen ? "▾" : "▸"}</span>
        ...
        <div style={S.split}>
          ...
          <section className="pane-card" style={S.pane}>
            <div style={S.paneHeader}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button onClick={run} disabled={loading || !model} className="btn-primary">
                  {loading ? "Running…" : "Run"}
                </button>
              </div>
            </div>
          ...
          <section className="pane-card" style={S.pane}>
            <div style={S.paneHeader}>
              <h2 style={S.paneTitle}>The Read</h2>
              <div style={S.metaPills}>
                {latencyMs != null && <span style={S.pill}>{latencyMs} ms</span>}
              ...
              {!error && !loading && !read && !rawContent && (
                <div style={S.empty}>
                  ...
                  <div style={{ fontSize: 15, color: "var(--text-mute)" }}>
                    Hit <strong style={{ color: "var(--text)" }}>Run</strong> to see Kael's three messages.
                  </div>
